...
def main():
    ...
    data_3hr_ = data_3hr[data_3hr['COMPOUND_NAME'] == 'colchicine']
    data_6hr_ = data_6hr[data_6hr['COMPOUND_NAME'] == 'colchicine']
    data_9hr_ = data_9hr[data_9hr['COMPOUND_NAME'] == 'colchicine']
    data_24hr_ = data_24hr[data_24hr['COMPOUND_NAME'] == 'colchicine']

    doseunit = str(list(set(data_3hr_['DOSE_UNIT']))[0])
    ...
    ax1_2.legend(loc='lower right', fontsize=4)
    ...
    ax2_2.legend(loc='lower right', fontsize=4)
    ...
    ax3_2.legend(loc='lower right', fontsize=4)
    ...
    ax4_2.legend(loc='lower right', fontsize=4)



    filename2 = '../data/scatterplot_ASTALT_RatVivo_DoseDependent_drug_TEST.png'
