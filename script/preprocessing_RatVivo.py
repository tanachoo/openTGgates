...
def main():
    ...
    att_ = att_[att_['TEST_TYPE'] == 'in vivo'] # Select 'in vitro' design
    ...
    file2 = '../data/Rat_vivo_liver_single_csv/*/celfiles/*csv'
    ...
    file3 = '../data/GPL1355-10794.txt' # Rat
    print(f'[LOAD]: {file3}')
    ...
    outputfile = '../data/RatVivoLiver_matrixTEST.txt'
